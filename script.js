...
var rect_max = [-0.2794752118323775, -0.5297359079192027];
var rect_min = [-0.6425349277723049, -0.6626432440196919];
...
document.addEventListener('scroll', function (event) {
    ...
    var cy = MapRange(0, canvasHeight, rect_min[1], rect_max[1], canvasHeight - mouse_y);
    rect_min[0] -= cx;
    rect_max[0] -= cx;
    rect_min[1] -= cy;
    rect_max[1] -= cy;
