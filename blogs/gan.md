...
$$
\theta^* = \underset{\theta}{\operatorname{argmin}} \sum_i - y_i \, \log f(x, \theta) - (1 - y_i) \, \log (1 - f(g(z, \phi), \theta))
$$
...
$$
\theta^* = \underset{\theta}{\operatorname{argmin}} \sum_i - \log f(x, \theta) - \log (1 - f(g(z, \phi), \theta))
$$
...
$$
\phi^*, \theta^* = \underset{\phi}{\operatorname{argmax}} \left\{ \underset{\theta}{\operatorname{min}} \sum_i - \log f(x, \theta) - \log (1 - f(g(z, \phi), \theta)) \right\}
$$
